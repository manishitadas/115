...
from_dir = "/Users/dasfam/Downloads"           # Add the path of you "Downloads" folder.
to_dir = "/Users/dasfam/Desktop/Document_Files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
